package com.teamone.beautality.utils;
...
public class PicassoRoundedCornersTransform implements Transformation {
    ...
    public PicassoRoundedCornersTransform(int radius, Corners corners) {
